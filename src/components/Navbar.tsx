...
const Navbar = () => {
    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-anthropic-beige/90 backdrop-blur-md py-4 border-b border-anthropic-stone/50' : 'bg-anthropic-beige md:bg-transparent py-4 md:py-6'}`}>
